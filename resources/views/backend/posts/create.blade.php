<x-layouts.backend.home>
    ...
    <x-slot:title> Postlar / Post yaratish </x-slot:title>

    <x-layouts.backend.header>  Postlar / Post yaratish </x-layouts.backend.header>

    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Post yaratish</h3>                   
                </div>
